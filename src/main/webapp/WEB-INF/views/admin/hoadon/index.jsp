...
<body>
 ...
 <main role="main">
     ...
     <hr>
	<form action="${rootpath }admin/hoadon/search3" method="get">
		<input type="text" name="search3" maxlength="50" placeholder="Tên khách hàng" value="${s }" />
	...
	<table border="1">
		...
		<c:forEach items="${lsthd }" var="hd">
			<tr>
<!-- 				<td align="center"><a -->
<%-- 					href="${rootpath }sanpham/detail?ma_sp=${sp.ma_sp }">${sp.ma_sp }</a> --%>
<!-- 				</td> -->
				<td>${hd.ma_hd }</td>
				<td>${hd.ten }</td>
				<td>${hd.phone }</td>
				<td>${hd.display_name }</td>
				<td>${hd.address }</td>
				...
				<td>${hd.note }</td>
				<th align="center"><a
					href="${rootpath }admin/hoadon/hoadonchitiet?ma_hd=${hd.ma_hd}"> <img
						src="${rootpath }assets/img/update.png" />
				</a></th>
				<th align="center"><a
					href="${rootpath }admin/hoadon/delete?ma_hd=${hd.ma_hd }"> <img
